                    ...
                    <div class="col-xl-7 mx-auto">
                        <div class="card border-top border-0 border-4 border-primary">
                            <div class="card-body p-5">
                                ...
                                <form  action="{{ route('room.edit', $room->id ) }}" method="POST" enctype="multipart/form-data" class="row g-3">
                                    @csrf
                                    <div class="col-md-12">
                                        <label for="inputName" class="form-label">Name</label>
                                        <input type="text" name="room_name" value ="{{ $room->room_name}}" class="form-control" id="inputName" >
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="row-12">
                                        ...
                                        <textarea class="form-control" id="inputAddress" name="description" value="{{ $room->description }}" placeholder="Description..." rows="3"></textarea>
                                    </div>
