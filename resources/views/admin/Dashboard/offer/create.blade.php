    ...
    <div class="col-lg">
        <div class="card">
            <div class="card-body ">
                ...
                <h4 class="header-title">Create Food</h4>
                </div>
                        ...
                        <div class="card border-top border-0 border-4 border-primary">
                            <div class="card-body p-5">
                                <div class="card-title d-flex align-items-center">
                                    ...
                                    <h5 class="mb-0 text-primary">Create Offer</h5>
                                </div>
                                <hr>
                                {{-- action="{{ route('brand.store') }}" --}}
                                <form  action="{{ route('offer.store') }}" method="POST" enctype="multipart/form-data" class="row g-3">
                                    @csrf
                                    <div class="col-md-12">
                                        <label for="inputName" class="form-label">Name</label>
                                        <input type="text" name="offer_name" class="form-control" id="inputName" required>
                                    </div>
                                    <div class="col-md-12">
