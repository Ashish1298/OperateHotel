                    ...
                    <div class="col-xl-7 mx-auto">
                        <div class="card border-top border-0 border-4 border-primary">
                            <div class="card-body p-5">
                                ...
                                <form  action="{{ route('offer.edit',$offers->id) }}" method="POST" enctype="multipart/form-data" class="row g-3">
                                    @csrf
                                    <div class="col-md-12">
                                        <label for="inputName" class="form-label">Name</label>
                                        <input type="text" name="offer_name" class="form-control"  value="{{ $offers->offer_name }}" id="inputName" required>
                                    </div>
                                    <div class="col-md-12">
