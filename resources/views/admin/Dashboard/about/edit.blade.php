    ...
    <div class="col-lg">
        <div class="card">
            <div class="card-body ">
                ...
                <h4 class="header-title">Update About Page Info</h4>
                </div>
                        ...
                        <div class="card border-top border-0 border-4 border-primary">
                            <div class="card-body p-5">
                                <div class="card-title d-flex align-items-center">
                                    ...
                                    <h5 class="mb-0 text-primary">Update About page info</h5>
                                </div>
                                <hr>
                                {{-- action="{{ route('brand.store') }}" --}}
                                <form  action="{{ route('about.edit',$abouts->id) }}" method="POST" enctype="multipart/form-data" class="row g-3">
                                    @csrf
                                    <div class="col-md-12">
                                    ...
                                    <div class="row-12">
                                        ...
                                        <textarea class="form-control" id="inputAddress" name="description" value="{{ $abouts->description }}" placeholder="Description..." rows="3"></textarea>
                                    </div>
